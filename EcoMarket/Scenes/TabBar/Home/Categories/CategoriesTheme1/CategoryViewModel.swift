    ...
    func getData() {
        ...
        DispatchQueue.global().asyncAfter(deadline: .now() + 2) { [weak self] in
            ...
            let mockData = [
                ...
                CategoryModel(image: "category/icon-5", name: "Electronics", productNumber: "190 Product"),
                CategoryModel(image: "category/icon-6", name: "Jewelry", productNumber: "80 Product")
            ]
